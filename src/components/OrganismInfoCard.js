...
const OrganismInfoCard = ({ selectedSpecies, handleClick, addToFavorites, currentUser }) => {
    ...
    return(
        <div>
            {selectedSpecies.Species.Image ? (selectedSpecies.Species.Image.URL ? <img src={selectedSpecies.Species.Image.URL} alt={selectedSpecies.Species.Image.Title}/> : selectedSpecies.Species.Image.map(image => <img key={image.URL} src={image.URL} alt={image.Title}/>)) :
            <div>
